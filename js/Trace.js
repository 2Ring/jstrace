...
(function (global, undefined) {
	...
	Trace.useHistoricalLog = function (useHistoricalLog) {
		/// <summary>
		///     Sets/Gets the userHistoricalLog setting (default: true)
		/// </summary>
		/// <param name="useHistoricalLog" type="Boolean" mayBeNull="false" optional="false">
		///     The useHistoricalLog message
		/// </param>
		/// <signature>
		///     <summary>
		///         Gets the useHistoricalLog setting (default: true)
		///     </summary>
		/// </signature>
		/// <signature>
		///     <summary>
		///         Sets the useHistoricalLog setting (default: true)
		///     </summary>
		///     <param name="useHistoricalLog" type="Boolean">
		///         The new useHistoricalLog setting
		///     </param>
		/// </signature>
		if (typeof useHistoricalLog === 'undefined') {
			return _useHistoricalLog;
		}
		_useHistoricalLog = useHistoricalLog;
	};
